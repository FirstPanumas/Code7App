...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x020002ca, ; uint32_t android_runtime_jnienv_class_token
	i32 u0x06001af9, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001af8, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [828 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.70_name, ; name: libaot-System.IO.Pipes.dll.so
		ptr null; void* handle
	}, ; 32
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.64_name, ; name: libaot-System.Diagnostics.Process.dll.so
		ptr null; void* handle
	}, ; 89
	%struct.DSOCacheEntry {
		i64 u0x1a8d67a1ccd35377, ; from name: aot-Code7App.dll.so
		i64 u0x5e7457eeaeb787d0, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Code7App.dll.so
		ptr null; void* handle
	}, ; 90
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x23804341c242257e, ; from name: Code7App.so
		i64 u0x5e7457eeaeb787d0, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Code7App.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x3259d406fe6b353e, ; from name: libaot-Code7App.so
		i64 u0x5e7457eeaeb787d0, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Code7App.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x5e7457eeaeb787d0, ; from name: libaot-Code7App.dll.so
		i64 u0x5e7457eeaeb787d0, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Code7App.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xada7d67993c5beac, ; from name: Code7App.dll.so
		i64 u0x5e7457eeaeb787d0, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Code7App.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xe4993120983aff2c, ; from name: aot-Code7App.so
		i64 u0x5e7457eeaeb787d0, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Code7App.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xe856ea535ec3320d, ; from name: aot-Code7App
		i64 u0x5e7457eeaeb787d0, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Code7App.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf3ad03275e24276a, ; from name: Code7App
		i64 u0x5e7457eeaeb787d0, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Code7App.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xfb84893852b6dcaf, ; from name: libaot-Code7App
		i64 u0x5e7457eeaeb787d0, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Code7App.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [25 x i8] c"com.companyname.code7app\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [23 x i8] c"libaot-Code7App.dll.so\00", align 16
...
@.DSOCacheEntry.64_name = private unnamed_addr constant [41 x i8] c"libaot-System.Diagnostics.Process.dll.so\00", align 16
...
@.DSOCacheEntry.70_name = private unnamed_addr constant [30 x i8] c"libaot-System.IO.Pipes.dll.so\00", align 16
